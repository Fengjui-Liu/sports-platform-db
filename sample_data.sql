-- ============================================================
-- SportBoard Sample Data
-- 適用於 schema.sql + migrations 後的最終狀態
-- ============================================================
...
TRUNCATE TABLE WORKOUTPLANSAVE;
TRUNCATE TABLE POSTBOOKMARK;
TRUNCATE TABLE POSTLIKE;
TRUNCATE TABLE COMMENT;
TRUNCATE TABLE POST;
TRUNCATE TABLE INVITATIONPARTICIPANT;
TRUNCATE TABLE WORKOUTINVITATION;
TRUNCATE TABLE WORKOUTSESSION;
TRUNCATE TABLE WORKOUTPLAN;
TRUNCATE TABLE BODYRECORD;
TRUNCATE TABLE SPORTBOARD;
TRUNCATE TABLE USER;
...
(1,  1, '籃球體能訓練計畫',    1, '健身重訓', 3, '深蹲、硬舉、跳繩',    '腿部、核心',   4, 12, NULL, NULL, NULL, '2025-02-01 10:00:00'),
(2,  2, '馬拉松備戰 12 週',    1, '跑步',     4, '長跑、間歇跑、恢復跑', NULL,          NULL, NULL, 42.2, 720,  NULL, '2025-02-10 09:00:00'),
(3,  3, '游泳耐力提升計畫',    1, '游泳',     3, '自由式連續游',         NULL,          NULL, NULL, 3.0,  90,   NULL, '2025-02-15 08:00:00'),
(4,  4, '羽球爆發力訓練',      1, '健身重訓', 2, '弓步蹲、側向跳、拉力', '腿部、肩部',  3, 15, NULL, NULL, NULL, '2025-03-01 10:00:00'),
(5,  5, '公路車長途備戰',      1, '騎車',     4, '長距離騎乘',           NULL,          NULL, NULL, 100.0,240,  NULL, '2025-03-05 07:00:00'),
(6,  6, '籃球專項力量訓練',    1, '健身重訓', 4, '臥推、肩推、引體向上', '胸部、肩部、背部', 5, 8, NULL, NULL, NULL, '2025-03-10 10:00:00'),
(7,  7, '女生居家重訓計畫',    1, '健身重訓', 1, '啞鈴訓練、彈力帶',     '全身',        3, 20, NULL, NULL, NULL, '2025-03-15 11:00:00'),
(8,  8, '五人制足球體能計畫',  1, '足球',     3, '短衝、折返跑、敏捷梯', NULL,          NULL, NULL, NULL, 60,   NULL, '2025-04-01 10:00:00'),
(9,  9, '攀岩核心強化計畫',    1, '極限運動', 3, '懸掛核心、握力訓練',   '核心、前臂',  4, 15, NULL, NULL, NULL, '2025-04-05 09:00:00'),
(10, 10,'網球發球力量訓練',    1, '健身重訓', 3, '旋轉核心、肩旋轉肌',   '肩部、核心',  3, 12, NULL, NULL, NULL, '2025-04-10 10:00:00'),
(11, 1, '個人重訓私人課表',    0, '健身重訓', 5, '奧林匹克舉重',         '全身',        5, 5,  NULL, NULL, NULL, '2025-04-15 10:00:00'),
(12, 2, '5K 速度提升計畫',     1, '跑步',     2, '間歇跑 400m x 8',      NULL,          NULL, NULL, 5.0,  30,   NULL, '2025-04-20 09:00:00');
...
-- ── BODYRECORD（每人 4 筆，共 40 筆）────────────────────────
INSERT INTO BODYRECORD (user_id, weight, height, body_fat, recorded_at) VALUES
(1, 75.5, 178.0, 15.2, '2025-02-01'), (1, 74.8, 178.0, 14.8, '2025-03-01'),
(1, 74.2, 178.0, 14.1, '2025-04-01'), (1, 73.5, 178.0, 13.5, '2025-05-01'),
(2, 68.0, 175.0, 12.0, '2025-02-01'), (2, 67.5, 175.0, 11.5, '2025-03-01'),
(2, 67.0, 175.0, 11.0, '2025-04-01'), (2, 66.5, 175.0, 10.8, '2025-05-01'),
(3, 58.0, 165.0, 20.5, '2025-02-01'), (3, 57.5, 165.0, 20.0, '2025-03-01'),
(3, 57.0, 165.0, 19.5, '2025-04-01'), (3, 56.5, 165.0, 19.0, '2025-05-01'),
(4, 70.0, 172.0, 16.0, '2025-02-01'), (4, 69.5, 172.0, 15.5, '2025-03-01'),
(4, 69.0, 172.0, 15.0, '2025-04-01'), (4, 68.5, 172.0, 14.8, '2025-05-01'),
(5, 55.0, 162.0, 22.0, '2025-02-01'), (5, 54.5, 162.0, 21.5, '2025-03-01'),
(5, 54.0, 162.0, 21.0, '2025-04-01'), (5, 53.5, 162.0, 20.5, '2025-05-01'),
(6, 82.0, 185.0, 14.0, '2025-02-01'), (6, 81.5, 185.0, 13.5, '2025-03-01'),
(6, 81.0, 185.0, 13.0, '2025-04-01'), (6, 80.5, 185.0, 12.5, '2025-05-01'),
(7, 52.0, 160.0, 24.0, '2025-02-01'), (7, 51.5, 160.0, 23.5, '2025-03-01'),
(7, 51.0, 160.0, 23.0, '2025-04-01'), (7, 50.5, 160.0, 22.5, '2025-05-01'),
(8, 72.0, 174.0, 17.0, '2025-02-01'), (8, 71.5, 174.0, 16.5, '2025-03-01'),
(8, 71.0, 174.0, 16.0, '2025-04-01'), (8, 70.5, 174.0, 15.5, '2025-05-01'),
(9, 65.0, 170.0, 13.0, '2025-02-01'), (9, 64.5, 170.0, 12.5, '2025-03-01'),
(9, 64.0, 170.0, 12.0, '2025-04-01'), (9, 63.5, 170.0, 11.5, '2025-05-01'),
(10,71.0, 176.0, 15.5, '2025-02-01'), (10,70.5, 176.0, 15.0, '2025-03-01'),
(10,70.0, 176.0, 14.5, '2025-04-01'), (10,69.5, 176.0, 14.0, '2025-05-01');
...
-- ── WORKOUTPLANSAVE（8 筆）──────────────────────────────────
INSERT INTO WORKOUTPLANSAVE (user_id, plan_id, saved_at) VALUES
